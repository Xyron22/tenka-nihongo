...
const EXAM_FILES={
  correct:'./assets/audio/exam/correct.mp3?v=5.1.1',
  wrong:'./assets/audio/exam/wrong.mp3?v=5.1.1',
  timeout:'./assets/audio/exam/timeout.mp3?v=5.1.1'
};
...
function resultFallback(){return false}
