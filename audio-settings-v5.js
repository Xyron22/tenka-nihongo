...
function examSettingsHtml(){
  ...
  <div class="muted-box">Feedback jawaban memakai MP3 pilihan kamu. Benar, salah, dan time up masing-masing satu bunyi. Voice Jepang hanya untuk mulai, selesai, dan perfect.</div>
  ...
  <div class="small-actions"><button class="pill" onclick="previewAudio('correct')">✅ Ding</button><button class="pill" onclick="previewAudio('wrong')">❌ Error</button><button class="pill" onclick="previewAudio('timeout')">⏱️ BRUH</button></div>
